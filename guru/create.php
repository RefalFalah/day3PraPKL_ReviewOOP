            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <!-- <li class="nav-item">
                            <a class="nav-link active" href="create.php">Jurusan</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="row">
                    <div class="col">
                        <div class="card w-50 mx-auto shadow p-3 mb-3 bg-body rounded">
                            <div class="card-body">
                                <h5 class="card-title text-center mb-3">Tambah Data Guru</h5>
                                <form action="" method="POST">
                                    <div class="mb-3">
                                        <label for="nip" class="form-label">NIP</label>                            
                                        <input type="number" name="nip" id="nip" autocomplete="off" required oninvalid="this.setCustomValidity('Masukan NIP! ')" oninput="setCustomValidity('')" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label for="nama" class="form-label">Nama</label>                            
                                        <input type="text" name="nama" id="nama" autocomplete="off" required oninvalid="this.setCustomValidity('Masukan Nama! ')" oninput="setCustomValidity('')" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label for="alamat" class="form-label">Alamat</label>                            
                                        <input type="text" name="alamat" id="alamat" autocomplete="off" required oninvalid="this.setCustomValidity('Masukan Alamat! ')" oninput="setCustomValidity('')" class="form-control">
                                    </div>
                                    <div class="row">
                                        <div class="col-10">
                                            <button type="submit" class="btn btn-dark btn-sm" name="tambah">Tambah</button>
                                        </div>
                                        <div class="col-2">
