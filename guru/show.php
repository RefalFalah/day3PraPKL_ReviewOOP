                ...
                <div class="row">
                    <div class="col">
                        <div class="card w-50 mx-auto shadow p-3 mb-3 bg-body rounded">
                            <div class="card-body">
                                <h5 class="card-title text-center mb-3">Show Data Guru</h5>
                                <form action="" method="POST">
                                    <div class="mb-3">
                                        <label for="nip" class="form-label">NIP</label>                            
                                        <input type="number" name="nip" id="nip" value= "<?= $data["nip"];?>" class="form-control" readonly>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-2">
                                            <a href="index.php" class="btn btn-danger btn-sm left">Kembali</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
